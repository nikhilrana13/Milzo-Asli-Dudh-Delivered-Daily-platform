...
const Vendors = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Milk Vendors Near You | Milzo</title>
        <meta
          name="description"
          content="Discover trusted dairy vendors near your location. Subscribe to fresh milk, paneer, curd and more with Milzo."
        />
      </Helmet>
      <div className='py-8'>
        {/* heading */}
