      ...
      type: [
        {
          ...
          time: {type:String,match: [/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, "Invalid time format"]}
        },
      ],
      default: [
        { slot: "morning", time: "",  match: [/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, "Invalid time format"]},
        { slot: "evening", time: "",  match: [/^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/, "Invalid time format"]},
      ],
    },
