...
const { GetAllVendors, ApproveAndRejectVendor, CreateCampaign, ToggleCampaignStatus, GetAllCampaigns, AdminDashboardStatsCard} = require("../controllers/admincontroller")

router.get("/allvendors",AuthMiddleware,IsAdmin,GetAllVendors)
router.get("/dashboard/stats",AuthMiddleware,IsAdmin,AdminDashboardStatsCard)
