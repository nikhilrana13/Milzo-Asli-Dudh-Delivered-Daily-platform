...
const { CreateSubscriptionBooking, UpdatePaymentStatus, VendorAllBookings, UserAllBookings, EachBookingDetails } = require("../controllers/bookingcontroller")
...
router.get("/booking/:id",AuthMiddleware,IsUser,EachBookingDetails)
// vendor routes
