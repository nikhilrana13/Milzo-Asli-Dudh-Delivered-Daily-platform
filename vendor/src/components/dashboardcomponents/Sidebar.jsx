...
const Sidebar = () => {
    ...
    const getNavClass = (isActive) => isActive ? "bg-emerald-50 text-emerald-700 font-[500]  px-3 py-3 rounded-md flex items-center gap-2 " :"px-3 py-3 mb-2 font-500 rounded-md hover:bg-emerald-50 hover:text-emerald-700 transition-all duration-300 text-slate-500";
